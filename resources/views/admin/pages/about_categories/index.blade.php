...
<div class="container-fluid">
    ...
    <button type="button" class="btn btn-success"><a class="text_custom" href="{{ route('about.create_category') }}">Create</a></button>
    <ol></ol>
    <div class="card mb-3">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $item->parent }}</td>
                            <td>
                                <button class="btn btn-warning"><a class="text_custom" href="{{ route('about.create_category',['id'=>$item->id]) }}">Edit</a></button>
                                <button class="btn btn-danger"><a class="text_custom delete" href="{{ route('about.delete_category',['id'=>$item->id]) }}">Delete</a></button>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
