                        ...
                        <div class="row">
							<div class="col-lg-10">
                                ...
                                <div class="form-group">
									...
									<select class="js-example-basic-single form-control" name="about_category_id">
							                <option>Select Category</option>
                                        @foreach($cate as $row) 
                                            <option value="{{ $row->id }}" {{ (isset($editItems) ? $editItems->about_category_id : '') == $row->id ? 'selected="selected"' : '' }}>{{ $row->title }}</option>
                                        @endforeach
									</select>
                                </div>
							</div>
